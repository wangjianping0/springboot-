...
/**
 * 指引去导入一个或多个Configuration类
 * Indicates one or more {@link Configuration @Configuration} classes to import.
 *
 * 提供的功能，类似于xml中的<import>语句，只有注解了@configuration的类，或者声明了至少一个bean方法的类，或者实现了ImportSelector
 * 、ImportBeanDefinitionRegistrar 时，才支持。
 ...
 *
 * 如果需要import xml文件，或者其他非@configuration bean定义资源，则使用 ImportResource
